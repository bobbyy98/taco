...
namespace taco {
  ...
  public:
    ...
    Iterator(IndexVar indexVar, ir::Expr tensor, Mode mode, Iterator parent, std::string name, bool useNameForPos = true);
    ...
    ModeFunction posAccess(const ir::Expr &pos, const std::vector<ir::Expr> &coords) const;
    ...
    ir::Stmt getInsertCoord(const ir::Expr &p, const std::vector<ir::Expr> &i) const;
    ir::Expr getWidth() const;
    ir::Stmt getInsertInitCoords(const ir::Expr &pBegin, const ir::Expr &pEnd) const;
    ir::Stmt getInsertInitLevel(const ir::Expr &szPrev, const ir::Expr &sz) const;
    ir::Stmt getInsertFinalizeLevel(const ir::Expr &szPrev, const ir::Expr &sz) const;
    ...
    ir::Stmt getAppendEdges(const ir::Expr &pPrev, const ir::Expr &pBegin, const ir::Expr &pEnd) const;
    ir::Expr getSize(const ir::Expr &szPrev) const;
    ir::Stmt getAppendInitEdges(const ir::Expr &pPrevBegin, const ir::Expr &pPrevEnd) const;
    ir::Stmt getAppendInitLevel(const ir::Expr &szPrev, const ir::Expr &sz) const;
    ir::Stmt getAppendFinalizeLevel(const ir::Expr &szPrev, const ir::Expr &sz) const;

    /// Return code for level functions that implement ungrouped insert
    /// capabilitiy.
    ir::Expr     getAssembledSize(const ir::Expr &prevSize) const;
    ir::Stmt     getSeqInitEdges(const ir::Expr &prevSize, const std::vector<AttrQueryResult> &queries) const;
    ir::Stmt     getSeqInsertEdge(const ir::Expr &parentPos, const std::vector<ir::Expr> &coords, const std::vector<AttrQueryResult> &queries) const;
    ir::Stmt     getInitCoords(const ir::Expr &prevSize, const std::vector<AttrQueryResult> &queries) const;
    ir::Stmt     getInitYieldPos(const ir::Expr &prevSize) const;
    ModeFunction getYieldPos(const ir::Expr &parentPos, const std::vector<ir::Expr> &coords) const;
    ir::Stmt     getInsertCoord(const ir::Expr &parentPos, const ir::Expr &pos, const std::vector<ir::Expr> &coords) const;

...
namespace taco {
  ...
  public:
    ...
    ModeFunction locate(ir::Expr parentPos, std::vector<ir::Expr> coords, Mode mode) const override;

    ir::Stmt getInsertCoord(ir::Expr p, const std::vector<ir::Expr> &i, Mode mode) const override;
    ir::Expr getWidth(Mode mode) const override;
    ir::Stmt getInsertInitCoords(ir::Expr pBegin, ir::Expr pEnd, Mode mode) const override;
    ir::Stmt getInsertInitLevel(ir::Expr szPrev, ir::Expr sz, Mode mode) const override;
    ir::Stmt getInsertFinalizeLevel(ir::Expr szPrev, ir::Expr sz, Mode mode) const override;

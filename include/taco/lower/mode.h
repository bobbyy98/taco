...
namespace taco {
  ...
  public:
    ...
    Mode(ir::Expr tensor, Dimension size, int mode, ModeFormat modeFormat, ModePack modePack, size_t packLoc, ModeFormat parentModeFormat);
  ...
  public:
    ModePack();
    ModePack(size_t numModes, ModeFormat modeType, ir::Expr tensor, int mode, int level);

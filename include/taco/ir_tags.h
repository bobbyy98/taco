...
namespace taco {
  ...
  enum class OutputRaceStrategy { IgnoreRaces, NoRaces, Atomics, Temporary, ParallelReduction };
  extern const char *OutputRaceStrategy_NAMES[];

  enum class BoundType { MinExact, MinConstraint, MaxExact, MaxConstraint };
  extern const char *BoundType_NAMES[];

  enum class AssembleStrategy { Append, Insert };
  ...
  enum class MergeStrategy { TwoFinger, Gallop };

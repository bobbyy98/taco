...
namespace taco {
  ...
  public:
    ...
    Precompute(IndexExpr expr, std::vector<IndexVar> i_vars, std::vector<IndexVar> iw_vars, TensorVar workspace);
  ...
  public:
    SetAssembleStrategy(TensorVar result, AssembleStrategy strategy, bool separatelySchedulable);

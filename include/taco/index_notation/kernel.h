...
namespace taco {
  ...
  public:
    ...
    Kernel(IndexStmt stmt, std::shared_ptr<ir::Module> module, void *evaluate, void *assemble, void *compute);
    ...
    template <typename... Args>
    bool assemble(const Args &...args) const {
    ...
    template <typename... Args>
    bool compute(const Args &...args) const {
      return compute({args...});
    }
    /// @}

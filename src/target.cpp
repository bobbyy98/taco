...
namespace taco {
  ...
  namespace {
    map<string, Target::Arch> archMap = {{"c99", Target::C99}, {"x86", Target::X86}};

    map<string, Target::OS> osMap = {{"unknown", Target::OSUnknown}, {"linux", Target::Linux}, {"macos", Target::MacOS}, {"windows", Target::Windows}};

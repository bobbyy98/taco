...
namespace taco {
  ...
  ir::Expr ModIntrinsic::lower(const std::vector<ir::Expr> &args) const {
    ...
    ir::Expr b = args[1];
      ...
      if (ir::isa<ir::Literal>(a) && ir::to<ir::Literal>(a)->equalsScalar(0.0)) {
        return a;
    }
  ...
  std::vector<std::vector<size_t>> ModIntrinsic::zeroPreservingArgs(const std::vector<IndexExpr> &args) const {
    return {{0}, {1}};
  }
  ...
  ir::Expr AbsIntrinsic::lower(const std::vector<ir::Expr> &args) const {
    ...
    ir::Expr arg = args[0];
      ...
      if (ir::isa<ir::Literal>(arg) && ir::to<ir::Literal>(arg)->equalsScalar(0.0)) {
        return arg;
    }
  ...
  std::vector<std::vector<size_t>> AbsIntrinsic::zeroPreservingArgs(const std::vector<IndexExpr> &args) const {
    return {{0}};
  }
  ...
  ir::Expr PowIntrinsic::lower(const std::vector<ir::Expr> &args) const {
    ...
    ir::Expr exponent = args[1];
      ...
      if ((ir::isa<ir::Literal>(base) && ir::to<ir::Literal>(base)->equalsScalar(0.0)) || (ir::isa<ir::Literal>(exponent) && ir::to<ir::Literal>(exponent)->equalsScalar(1.0))) {
        return base;
    }

    const bool exponentZero = (ir::isa<ir::Literal>(exponent) && ir::to<ir::Literal>(exponent)->equalsScalar(0.0));

      switch (base.type().getKind()) {
        case Datatype::Float32:
          return exponentZero ? ir::Literal::make((float) 1.0) : ir::Call::make("powf", args, base.type());
        case Datatype::Float64:
          return exponentZero ? ir::Literal::make((double) 1.0) : ir::Call::make("pow", args, base.type());
        case Datatype::Complex64:
          return exponentZero ? ir::Literal::make(std::complex<float>(1.0)) : ir::Call::make("cpowf", args, base.type());
        case Datatype::Complex128:
          return exponentZero ? ir::Literal::make(std::complex<double>(1.0)) : ir::Call::make("cpow", args, base.type());
        default:
          taco_not_supported_yet;
          break;
      }
  ...
  std::vector<std::vector<size_t>> PowIntrinsic::zeroPreservingArgs(const std::vector<IndexExpr> &args) const {
    return {{0}};
  }
  ...
  std::vector<std::vector<size_t>> SquareIntrinsic::zeroPreservingArgs(const std::vector<IndexExpr> &args) const {
    return {{0}};
  }
  ...
  std::vector<std::vector<size_t>> CubeIntrinsic::zeroPreservingArgs(const std::vector<IndexExpr> &args) const {
    return {{0}};
  }
  ...
  ir::Expr SqrtIntrinsic::lower(const std::vector<ir::Expr> &args) const {
    ...
    ir::Expr arg = args[0];
      ...
      if (ir::isa<ir::Literal>(arg) && (ir::to<ir::Literal>(arg)->equalsScalar(0.0) || ir::to<ir::Literal>(arg)->equalsScalar(1.0))) {
        return arg;
    }
  ...
  std::vector<std::vector<size_t>> SqrtIntrinsic::zeroPreservingArgs(const std::vector<IndexExpr> &args) const {
    return {{0}};
  }
  ...
  ir::Expr CbrtIntrinsic::lower(const std::vector<ir::Expr> &args) const {
    ...
    ir::Expr arg = args[0];
      ...
      if (ir::isa<ir::Literal>(arg) && (ir::to<ir::Literal>(arg)->equalsScalar(0.0) || ir::to<ir::Literal>(arg)->equalsScalar(1.0) || ir::to<ir::Literal>(arg)->equalsScalar(-1.0))) {
        return arg;
    }
  ...
  std::vector<std::vector<size_t>> CbrtIntrinsic::zeroPreservingArgs(const std::vector<IndexExpr> &args) const {
    return {{0}};
  }
  ...
  ir::Expr ExpIntrinsic::lower(const std::vector<ir::Expr> &args) const {
    ...
    ir::Expr   arg     = args[0];
    const bool argZero = (ir::isa<ir::Literal>(arg) && ir::to<ir::Literal>(arg)->equalsScalar(0.0));

      switch (arg.type().getKind()) {
        case Datatype::Float32:
          return argZero ? ir::Literal::make((float) 1.0) : ir::Call::make("expf", args, arg.type());
        case Datatype::Float64:
          return argZero ? ir::Literal::make((double) 1.0) : ir::Call::make("exp", args, arg.type());
        case Datatype::Complex64:
          return argZero ? ir::Literal::make(std::complex<float>(1.0)) : ir::Call::make("cexpf", args, arg.type());
        case Datatype::Complex128:
          return argZero ? ir::Literal::make(std::complex<double>(1.0)) : ir::Call::make("cexp", args, arg.type());
        default:
          taco_not_supported_yet;
          break;
      }
  ...
  std::vector<std::vector<size_t>> ExpIntrinsic::zeroPreservingArgs(const std::vector<IndexExpr> &args) const {
    return {};
  }
  ...
  ir::Expr LogIntrinsic::lower(const std::vector<ir::Expr> &args) const {
    ...
    ir::Expr arg = args[0];
      ...
      if (ir::isa<ir::Literal>(arg) && ir::to<ir::Literal>(arg)->equalsScalar(1.0)) {
  ...
  std::vector<std::vector<size_t>> LogIntrinsic::zeroPreservingArgs(const std::vector<IndexExpr> &args) const {
    return {};
  }
  ...
  std::vector<std::vector<size_t>> Log10Intrinsic::zeroPreservingArgs(const std::vector<IndexExpr> &args) const {
    return {};
  }
  ...
  std::vector<std::vector<size_t>> SinIntrinsic::zeroPreservingArgs(const std::vector<IndexExpr> &args) const {
    return {{0}};
  }
  ...
  ir::Expr CosIntrinsic::lower(const std::vector<ir::Expr> &args) const {
    ...
    const bool argZero = (ir::isa<ir::Literal>(arg) && ir::to<ir::Literal>(arg)->equalsScalar(0.0));
      ...
      switch (arg.type().getKind()) {
        case Datatype::Float32:
          return argZero ? ir::Literal::make((float) 1.0) : ir::Call::make("cosf", args, arg.type());
        case Datatype::Float64:
          return argZero ? ir::Literal::make((double) 1.0) : ir::Call::make("cos", args, arg.type());
        case Datatype::Complex64:
          return argZero ? ir::Literal::make(std::complex<float>(1.0)) : ir::Call::make("ccosf", args, arg.type());
        case Datatype::Complex128:
          return argZero ? ir::Literal::make(std::complex<double>(1.0)) : ir::Call::make("ccos", args, arg.type());
        default:
          taco_not_supported_yet;
          break;
      }
  ...
  std::vector<std::vector<size_t>> CosIntrinsic::zeroPreservingArgs(const std::vector<IndexExpr> &args) const {
    return {};
  }
  ...
  std::vector<std::vector<size_t>> TanIntrinsic::zeroPreservingArgs(const std::vector<IndexExpr> &args) const {
    return {{0}};
  }
  ...
  std::vector<std::vector<size_t>> AsinIntrinsic::zeroPreservingArgs(const std::vector<IndexExpr> &args) const {
    return {{0}};
  }
  ...
  std::vector<std::vector<size_t>> AcosIntrinsic::zeroPreservingArgs(const std::vector<IndexExpr> &args) const {
    return {};
  }
  ...
  std::vector<std::vector<size_t>> AtanIntrinsic::zeroPreservingArgs(const std::vector<IndexExpr> &args) const {
    return {{0}};
  }
  ...
  ir::Expr Atan2Intrinsic::lower(const std::vector<ir::Expr> &args) const {
    ...
    ir::Expr b = args[1];
      ...
      if (ir::isa<ir::Literal>(a) && ir::to<ir::Literal>(a)->equalsScalar(0.0) && ir::isa<ir::Literal>(b) && ir::to<ir::Literal>(b)->equalsScalar(0.0)) {
        return a;
    }
  ...
  std::vector<std::vector<size_t>> Atan2Intrinsic::zeroPreservingArgs(const std::vector<IndexExpr> &args) const {
    taco_iassert(args.size() == 2);
  ...
  std::vector<std::vector<size_t>> SinhIntrinsic::zeroPreservingArgs(const std::vector<IndexExpr> &args) const {
    return {{0}};
  }
  ...
  ir::Expr CoshIntrinsic::lower(const std::vector<ir::Expr> &args) const {
    ...
    const bool argZero = (ir::isa<ir::Literal>(arg) && ir::to<ir::Literal>(arg)->equalsScalar(0.0));
      ...
      switch (arg.type().getKind()) {
        case Datatype::Float32:
          return argZero ? ir::Literal::make((float) 1.0) : ir::Call::make("coshf", args, arg.type());
        case Datatype::Float64:
          return argZero ? ir::Literal::make((double) 1.0) : ir::Call::make("cosh", args, arg.type());
        case Datatype::Complex64:
          return argZero ? ir::Literal::make(std::complex<float>(1.0)) : ir::Call::make("ccoshf", args, arg.type());
        case Datatype::Complex128:
          return argZero ? ir::Literal::make(std::complex<double>(1.0)) : ir::Call::make("ccosh", args, arg.type());
        default:
          taco_not_supported_yet;
          break;
      }
  ...
  std::vector<std::vector<size_t>> CoshIntrinsic::zeroPreservingArgs(const std::vector<IndexExpr> &args) const {
    return {};
  }
  ...
  std::vector<std::vector<size_t>> TanhIntrinsic::zeroPreservingArgs(const std::vector<IndexExpr> &args) const {
    return {{0}};
  }
  ...
  std::vector<std::vector<size_t>> AsinhIntrinsic::zeroPreservingArgs(const std::vector<IndexExpr> &args) const {
    return {{0}};
  }
  ...
  std::vector<std::vector<size_t>> AcoshIntrinsic::zeroPreservingArgs(const std::vector<IndexExpr> &args) const {
    return {};
  }
  ...
  std::vector<std::vector<size_t>> AtanhIntrinsic::zeroPreservingArgs(const std::vector<IndexExpr> &args) const {
    return {{0}};
  }
  ...
  std::vector<std::vector<size_t>> GtIntrinsic::zeroPreservingArgs(const std::vector<IndexExpr> &args) const {
    taco_iassert(args.size() == 2);
  ...
  std::vector<std::vector<size_t>> LtIntrinsic::zeroPreservingArgs(const std::vector<IndexExpr> &args) const {
    taco_iassert(args.size() == 2);
  ...
  std::vector<std::vector<size_t>> GteIntrinsic::zeroPreservingArgs(const std::vector<IndexExpr> &args) const {
    taco_iassert(args.size() == 2);
  ...
  std::vector<std::vector<size_t>> LteIntrinsic::zeroPreservingArgs(const std::vector<IndexExpr> &args) const {
    taco_iassert(args.size() == 2);
  ...
  std::vector<std::vector<size_t>> EqIntrinsic::zeroPreservingArgs(const std::vector<IndexExpr> &args) const {
    return {};
  }
  ...
  std::vector<std::vector<size_t>> NeqIntrinsic::zeroPreservingArgs(const std::vector<IndexExpr> &args) const {
  ...
  std::vector<std::vector<size_t>> MaxIntrinsic::zeroPreservingArgs(const std::vector<IndexExpr> &args) const {
    taco_iassert(args.size() == 2);
  ...
  std::vector<std::vector<size_t>> MinIntrinsic::zeroPreservingArgs(const std::vector<IndexExpr> &args) const {
    taco_iassert(args.size() == 2);
  ...
  ir::Expr HeavisideIntrinsic::lower(const std::vector<ir::Expr> &args) const {
    ...
    return ir::Add::make(ir::Mul::make(b, ir::Cast::make(equalsZero, a.type())), ir::Cast::make(ir::Gt::make(a, zero), a.type()));
  }

  std::vector<std::vector<size_t>> HeavisideIntrinsic::zeroPreservingArgs(const std::vector<IndexExpr> &args) const {
    taco_iassert(args.size() == 2);
  ...
  ir::Expr NotIntrinsic::lower(const std::vector<ir::Expr> &args) const {
    ...
    ir::Expr a = args[0];
      ...
      if (ir::isa<ir::Literal>(a) && ir::to<ir::Literal>(a)->equalsScalar(0)) {
  ...
  std::vector<std::vector<size_t>> NotIntrinsic::zeroPreservingArgs(const std::vector<IndexExpr> &args) const {
    return {};
  }

...
namespace taco {
  ...
  template <>
  bool isa<Annihilator>(const Property &p) {
    return isa<AnnihilatorPtr>(p.ptr);
  }

  template <>
  Annihilator to<Annihilator>(const Property &p) {
  ...
  template <>
  bool isa<Identity>(const Property &p) {
    return isa<IdentityPtr>(p.ptr);
  }

  template <>
  Identity to<Identity>(const Property &p) {
  ...
  template <>
  bool isa<Associative>(const Property &p) {
    return isa<AssociativePtr>(p.ptr);
  }

  template <>
  Associative to<Associative>(const Property &p) {
  ...
  template <>
  bool isa<Commutative>(const Property &p) {
    return isa<CommutativePtr>(p.ptr);
  }

  template <>
  Commutative to<Commutative>(const Property &p) {

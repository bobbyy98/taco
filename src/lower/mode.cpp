...
namespace taco {
  ...
  Mode::Mode(ir::Expr tensor, Dimension size, int mode, ModeFormat modeFormat, ModePack modePack, size_t packLoc, ModeFormat parentModeFormat):
      content(new Content) {
  ...
  ModePack::ModePack(size_t numModes, ModeFormat modeType, ir::Expr tensor, int mode, int level): ModePack() {

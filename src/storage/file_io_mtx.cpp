...
namespace taco {
  ...
  TensorBase dispatchReadMTX(std::istream &stream, const T &format, bool pack) {
    ...
    // type = [matrix tensor]
    taco_uassert((type == "matrix") || (type == "tensor")) << "Unknown type of MatrixMarket";
    ...
    taco_uassert((symmetry == "general") || (symmetry == "symmetric")) << "MatrixMarket symmetry not available";
  ...
  template <typename T>
  TensorBase dispatchReadSparse(std::istream &stream, const T &format, bool symm) {
    string line;
  ...
  TensorBase readSparse(std::istream &stream, const ModeFormat &modetype, bool symm) {
  ...
  TensorBase dispatchReadDense(std::istream &stream, const T &format, bool symm) {
    ...
    vector<double> values;
    auto           size = std::accumulate(begin(dimensions), end(dimensions), 1, std::multiplies<double>());
    values.reserve(size);
  ...
  TensorBase readDense(std::istream &stream, const ModeFormat &modetype, bool symm) {
  ...
  void writeSparse(std::ostream &stream, const TensorBase &tensor) {
      switch (tensor.getComponentType().getKind()) {
        case Datatype::Bool:
          writeSparseTyped<bool>(stream, tensor);
          break;
        case Datatype::UInt8:
          writeSparseCharTyped<uint8_t>(stream, tensor);
          break;
        case Datatype::UInt16:
          writeSparseTyped<uint16_t>(stream, tensor);
          break;
        case Datatype::UInt32:
          writeSparseTyped<uint32_t>(stream, tensor);
          break;
        case Datatype::UInt64:
          writeSparseTyped<uint64_t>(stream, tensor);
          break;
        case Datatype::UInt128:
          writeSparseTyped<unsigned long long>(stream, tensor);
          break;
        case Datatype::Int8:
          writeSparseCharTyped<int8_t>(stream, tensor);
          break;
        case Datatype::Int16:
          writeSparseTyped<int16_t>(stream, tensor);
          break;
        case Datatype::Int32:
          writeSparseTyped<int32_t>(stream, tensor);
          break;
        case Datatype::Int64:
          writeSparseTyped<int64_t>(stream, tensor);
          break;
        case Datatype::Int128:
          writeSparseTyped<long long>(stream, tensor);
          break;
        case Datatype::Float32:
          writeSparseTyped<float>(stream, tensor);
          break;
        case Datatype::Float64:
          writeSparseTyped<double>(stream, tensor);
          break;
        case Datatype::Complex64:
          writeSparseTyped<std::complex<float>>(stream, tensor);
          break;
        case Datatype::Complex128:
          writeSparseTyped<std::complex<double>>(stream, tensor);
          break;
  ...
  void writeDense(std::ostream &stream, const TensorBase &tensor) {
      switch (tensor.getComponentType().getKind()) {
        case Datatype::Bool:
          writeDenseTyped<bool>(stream, tensor);
          break;
        case Datatype::UInt8:
          writeDenseCharTyped<uint8_t>(stream, tensor);
          break;
        case Datatype::UInt16:
          writeDenseTyped<uint16_t>(stream, tensor);
          break;
        case Datatype::UInt32:
          writeDenseTyped<uint32_t>(stream, tensor);
          break;
        case Datatype::UInt64:
          writeDenseTyped<uint64_t>(stream, tensor);
          break;
        case Datatype::UInt128:
          writeDenseTyped<unsigned long long>(stream, tensor);
          break;
        case Datatype::Int8:
          writeDenseCharTyped<int8_t>(stream, tensor);
          break;
        case Datatype::Int16:
          writeDenseTyped<int16_t>(stream, tensor);
          break;
        case Datatype::Int32:
          writeDenseTyped<int32_t>(stream, tensor);
          break;
        case Datatype::Int64:
          writeDenseTyped<int64_t>(stream, tensor);
          break;
        case Datatype::Int128:
          writeDenseTyped<long long>(stream, tensor);
          break;
        case Datatype::Float32:
          writeDenseTyped<float>(stream, tensor);
          break;
        case Datatype::Float64:
          writeDenseTyped<double>(stream, tensor);
          break;
        case Datatype::Complex64:
          writeDenseTyped<std::complex<float>>(stream, tensor);
          break;
        case Datatype::Complex128:
          writeDenseTyped<std::complex<double>>(stream, tensor);
          break;
        case Datatype::Undefined:
          taco_ierror;
          break;

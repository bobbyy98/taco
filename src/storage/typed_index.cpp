...
namespace taco {
  ...
  void TypedIndexVal::set(TypedComponentVal value) {
    dType = value.getType();
      switch (dType.getKind()) {
        case Datatype::UInt8:
          val.uint8Value = value.get().uint8Value;
          break;
        case Datatype::UInt16:
          val.uint16Value = value.get().uint16Value;
          break;
        case Datatype::UInt32:
          val.uint32Value = value.get().uint32Value;
          break;
        case Datatype::UInt64:
          val.uint64Value = value.get().uint64Value;
          break;
        case Datatype::Int8:
          val.int8Value = value.get().int8Value;
          break;
        case Datatype::Int16:
          val.int16Value = value.get().int16Value;
          break;
        case Datatype::Int32:
          val.int32Value = value.get().int32Value;
          break;
        case Datatype::Int64:
          val.int64Value = value.get().int64Value;
          break;
        case Datatype::Bool:
        case Datatype::UInt128:
        case Datatype::Int128:
